...
// Diğer ürünleri gösteren RecyclerView için adaptör sınıfı
class OtherAdapter(private val itemList: List<ProductModel?>) : RecyclerView.Adapter<OtherAdapter.ViewHolder>() {

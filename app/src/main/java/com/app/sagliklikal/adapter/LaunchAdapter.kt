...
// Ürünleri gösteren RecyclerView için adaptör sınıfı
class LaunchAdapter(private val itemList: List<ProductModel?>) : RecyclerView.Adapter<LaunchAdapter.ViewHolder>() {
